      ...
      body: {
        head: {
          ...
          contacts: [
            ...
            {
              id: 3,
              cont: "evdev-portfolio.web.app",
              link: "https://evdev-portfolio.web.app",
              icon: "website",
            },
            {
              id: 4,
        ...
        expBlock: {
          ...
          exp: [
            ...
            },
            {
              ...
              date_to: "Апрель 2021",
              work_type: "Фриланс",
              about: `Разработан и собран на платфоме Tilda. Сайт полностью отвечает требованиям заказчика. Интуитивно понятен для 
              клиента и прост в использовании, а так же является настоящим "магнитом" для новых "лидов".`,
            },
            {
              id: 143523035,
              title: "Сайт ставок на спорт на React.js",
              date_from: "Март 2021",
              date_to: "Март 2021",
              work_type: "Фриланс",
              about: `Разработан сайт с учетом потребности клиента на React.js
              Дизайн сайта полностью соответствует требованию клиента об использовании темных "ноток".
              А отличительной чертой сайта является использование "неоновых" стилей
              Подключены ADS сервисы для повышения трафика. Реклама настроена на жителей USA
              Разработан именно на React , так как клиент собирается расширять функционал по типу SPA`,
            },
            {
        ...
        skillsBlock: {
          ...
          langsBlock: {
            ...
            langs: [
              ...
              {
                id: 2,
                lang: 'English <span class="text-muted">(Pre-intermediate)</span>',
              },
            ],
          },
          interestsBlock: {
      ...
      body: {
        ...
        form: {
          ...
          validate: {
            ...
            phone: {
              num: 10,
              validate: `Номер телефона должен состоять не менее чем из 10 цифр`,
